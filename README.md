...
![Sound Options](/images/SoundOptions.png)

- Enable Alarm Sound: You can hear the sound.
- Custom Sound Path: If you want to customize the default sound, you can add your own; using .wav is suggested.
- Alarm Duration: The time at which the sound will repeat

Available sound options can be configured to customize your timer notifications.
